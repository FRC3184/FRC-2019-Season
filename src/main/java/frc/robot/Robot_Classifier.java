...
public class Robot_Classifier extends TimedRobot {
    ...
    public void disabledInit() {
        System.out.println("Robot_Real disabled");
        drive.tankDrive(0, 0);
    }
    ...
    public void teleopInit() {
        System.out.println("Robot_Real in operator control mode");
    }
    ...
    public void autonomousInit() {
        System.out.println("Robot_Real in autonomous mode");
    }
