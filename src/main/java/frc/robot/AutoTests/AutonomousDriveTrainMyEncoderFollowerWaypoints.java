...
public class AutonomousDriveTrainMyEncoderFollowerWaypoints extends Subsystem {
    ...
    public AutonomousDriveTrainMyEncoderFollowerWaypoints() {
    ...
    public void setupPath() {
        ...
        m_left_follower = new MyEncoderFollower(modifier.getLeftTrajectory());
        m_right_follower = new MyEncoderFollower(modifier.getRightTrajectory());
