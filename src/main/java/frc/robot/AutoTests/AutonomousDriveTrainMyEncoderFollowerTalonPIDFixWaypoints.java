...
public class AutonomousDriveTrainMyEncoderFollowerTalonPIDFixWaypoints extends Subsystem {
    ...
    private MyEncoderFollowerTalonPIDFix m_left_follower;
    private MyEncoderFollowerTalonPIDFix m_right_follower;

    boolean m_finished = false;

    public AutonomousDriveTrainMyEncoderFollowerTalonPIDFixWaypoints() {
    ...
    public void setupPath() {
        ...
        m_left_follower = new MyEncoderFollowerTalonPIDFix(modifier.getLeftTrajectory());
        m_right_follower = new MyEncoderFollowerTalonPIDFix(modifier.getRightTrajectory());
